...
const BASE_URL = 'https://cdn.jsdelivr.net/gh/oliviabancroft0-prog/5-5-2026@main/';
...
export const MODELS: Product[] = [
  ...
  { 
    id: 'elodie', 
    name: 'Elodie', 
    subtitle: 'London Luxury Signature', 
    location: 'Mayfair', 
    instagram: '@elodie_lux', 
    onlyfans: 'onlyfans.com/elodie_elite',
    bio: 'Elodie combines high-end luxury aesthetics with strategic digital engagement. Based in Mayfair, her portfolio is defined by sophisticated visual storytelling and a deep understanding of premium brand positioning in the UK market.',
    price: '£550/Session', 
    image: `${BASE_URL}SaveVid.Net_476413573_18487195888011641_745131904459908597_n.jpg`,
    gallery: [
      `${BASE_URL}SaveVid.Net_476475036_18487195918011641_5333981513058256350_n.jpg`,
      `${BASE_URL}SaveVid.Net_476476902_18487195909011641_6810221596687855788_n.jpg`
    ]
  }
];
